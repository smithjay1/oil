...
import { Award, MapPin, Users, TrendingUp, Zap, Shield, Globe } from "lucide-react";
          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  Our deep commitment reaches as growing technological efficiency 
                  to provide sustainable oil and energy solutions, and highly renewable and 
                  profitable operations. Our strategic partnerships with refineries, 
                  environmental and political institutions strengthen our position. Our intensive research 
                  experience in this business model is based on success and sustainable growth.
                </p>
              </div>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-center text-muted-foreground mt-6 text-lg">
              Interactive presentation showing our comprehensive oil operations and commitment to excellence
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-dark-card">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-5xl font-bold text-center mb-12">Our <span className="text-gold">Values</span></h2>
            <p className="text-center text-muted-foreground mb-12 max-w-3xl mx-auto text-lg">
              We commit all our people, offices and projects to manufacture high-performance solutions for economic success, 
              welcoming our people, customers and communities, and making positive steps toward cleaner environment solutions, 
              safe operations, and protecting futures.
            </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <motion.div variants={itemVariants} className="space-y-6">
                {[
                  {
                    icon: "🛡️",
                    title: "Zero Threshold and zero harm to work with - No one should be injured, harmed, or penalized.",
                    color: "text-gold"
                  },
                  {
                    icon: "🤝",
                    title: "Creating true relationships and strengthening opportunities - We create life-long business partnerships."
                  },
                  {
                    icon: "⚡",
                    title: "Working collectively towards changes - work together and achievements will be accelerated and optimized."
                  },
                  {
                    icon: "🏆",
                    title: "Step forward our way - We secure better living and provide excellent services."
                  }
                ].map((value, index) => (
                  <motion.div
                    key={index}
                  ...
                  >
                    ...
                    <div>
                      <h4 className={`font-semibold mb-1 ${value.color || 'text-foreground'}`}>
                        {value.title}
                      </h4>
                    </div>
                  </motion.div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  <ul className="space-y-2 text-lg">
                    <li>• Safety responsibility for everyone and ethical operations</li>
      ...
      <section className="py-20 bg-dark-card">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-5xl font-bold text-center mb-12">Company <span className="text-gold">Facts</span></h2>
            <div className="grid md:grid-cols-3 gap-8 text-center">
              {[
                ...
                >
                  ...
                  <div className="text-4xl font-bold text-gold mb-2">{fact.number}</div>
                  <div className="text-muted-foreground text-lg">{fact.label}</div>
                </motion.div>
              ))}
            </div>
          </motion.div>
          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed text-lg">
                Our strategic effort is to improve the industry's leading extraction of high 
                performance oil operations, which enables us to further enhance our competitive advantage 
                through key priorities and innovative technologies.
              </p>
      ...
      <section className="py-20 bg-dark-card">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-5xl font-bold text-center mb-12">Company <span className="text-gold">Documentation</span></h2>
            <div className="grid md:grid-cols-4 gap-6">
              {[
                { title: "2023 Annual Report", bg: "bg-gold text-dark-bg" },
                { title: "2023 Safety Report", bg: "bg-dark-bg border border-gold text-gold" },
                { title: "Company Brochure", bg: "bg-gold text-dark-bg" },
                { title: "Financial Information", bg: "bg-dark-bg border border-gold text-gold" }
              ].map((doc, index) => (
                <motion.div
                  key={index}
      ...
      <section className="py-20 bg-dark-bg">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-5xl font-bold text-center mb-12">Global <span className="text-gold">Operations Network</span></h2>
            <p className="text-center text-muted-foreground mb-12 max-w-3xl mx-auto text-lg">
              Our worldwide infrastructure connects energy resources with global markets through strategic partnerships and cutting-edge technology.
            </p>
              ...
              {[
                {
                  ...
                  image: "https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?w=400&h=300&fit=crop&auto=format",
                  description: "Advanced offshore and onshore drilling operations across 6 continents",
                  icon: "🛢️"
                },
                {
                  title: "Refining Operations",
                  image: "https://images.unsplash.com/photo-1562690868-60bbe7293e94?w=400&h=300&fit=crop&auto=format",
                  description: "State-of-the-art refineries processing millions of barrels daily",
                  icon: "🏭"
                },
                {
                  title: "Distribution Network",
                  image: "https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?w=400&h=300&fit=crop&auto=format",
                  description: "Extensive pipeline and transportation infrastructure worldwide",
                  icon: "🚛"
                },
                {
                  ...
                  description: "Research and development facilities driving innovation",
                  icon: "🔬"
                }
              ].map((operation, index) => (
                <motion.div
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center mb-3">
                      ...
                      <h3 className="text-xl font-bold text-gold">{operation.title}</h3>
                    </div>
