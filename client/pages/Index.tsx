        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Comprehensive energy solutions tailored to meet your specific
              needs
            </motion.p>
          </motion.div>
            ...
            {[
              {
                ...
                desc: "Advanced exploration techniques using cutting-edge technology to locate and assess oil reserves.",
              },
              {
                icon: Shield,
                title: "Refinery Operations",
                desc: "State-of-the-art refining processes ensuring maximum efficiency and environmental compliance.",
              },
              {
                icon: Globe,
                title: "Distribution Network",
                desc: "Extensive distribution infrastructure delivering products safely and efficiently worldwide.",
              },
              {
                icon: Users,
                title: "Consulting Services",
                desc: "Expert consultation for energy projects, regulatory compliance, and strategic planning.",
              },
              {
                icon: Award,
                title: "Environmental Solutions",
                desc: "Sustainable practices and environmental protection measures for responsible energy production.",
              },
              {
                icon: TrendingUp,
                title: "Technical Support",
                desc: "24/7 technical support and maintenance services for optimal operational performance.",
              },
            ].map((service, index) => (
              <motion.div
                key={index}
              ...
              >
                <Card className="bg-dark-bg border-dark-border hover:border-gold transition-all duration-300 relative overflow-hidden group h-full">
                  ...
                  <CardContent className="p-8 relative z-10">
                    ...
                    <motion.h3 className="text-xl font-semibold mb-4 group-hover:text-gold transition-colors">
                      {service.title}
                    </motion.h3>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h2 className="text-5xl font-bold mb-6">
              Premium <span className="text-gold">Crude Oil</span> Trading
            </h2>
            <p className="text-muted-foreground max-w-3xl mx-auto text-lg">
              We specialize in sourcing, refining, and delivering the world's
              finest crude oil varieties. From light sweet crude to heavy sour
              blends, we provide premium petroleum solutions globally.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                image: "🛢️",
                description:
                  "Premium benchmark crude oil with exceptional refining yields",
              },
              {
                name: "Brent Crude",
                grade: "Light Sweet Crude",
                ...
                image: "⚫",
                description:
                  "North Sea crude oil, global pricing benchmark for Atlantic Basin",
              },
              {
                name: "Dubai Crude",
                ...
                image: "🏜️",
                description:
                  "Middle Eastern crude oil ideal for heavy fuel oil production",
              },
              {
                name: "Maya Heavy",
                ...
                image: "🌊",
                description:
                  "Mexican crude perfect for specialized refinery operations",
              },
              {
                name: "Bonny Light",
                grade: "Light Sweet Crude",
                ...
                image: "💎",
                description:
                  "Nigerian premium crude with excellent gasoline yields",
              },
              {
                name: "Urals Crude",
                grade: "Medium Sour Crude",
                ...
                image: "❄️",
                description:
                  "Russian export blend ideal for European refineries",
              },
            ].map((oil, index) => (
              <motion.div
                key={index}
          ...
          >
            {[
              ...
              {
                number: "24/7",
                label: "Global Trading Operations",
                icon: "🌍",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Explore our portfolio of successful energy projects around the
              world
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Advanced offshore drilling platform producing 150,000 barrels daily",
              },
              {
                ...
                description:
                  "State-of-the-art refinery processing 500,000 barrels per day",
              },
              {
                ...
                description:
                  "Strategic petroleum reserve with 50 million barrel capacity",
              },
              {
                ...
                description:
                  "2,500-mile pipeline system transporting crude oil safely",
              },
              {
                ...
                description:
                  "Integrated facility producing refined petroleum products",
              },
              {
                ...
                description:
                  "Liquefied natural gas facility for global energy distribution",
              },
            ].map((project, index) => (
              <motion.div
                key={index}
